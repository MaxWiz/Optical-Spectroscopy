...
String filename="C:/Users/labuser/Documents/GitHub/Optical-Spectroscopy/WhiteLED_10-8_3-9nm_run1.txt";
...
void plot(){
  ...
  fill(0);
  textSize(30);
  String shortName = filename.substring(55, filename.length());
