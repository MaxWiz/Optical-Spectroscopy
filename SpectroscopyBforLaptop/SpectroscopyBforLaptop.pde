...
String filename="C:/Users/maxwi/Documents/GitHub/Optical-Spectroscopy/YellowLED_10-7_3-9nm_run2.txt";
...
void plot(){
  ...
  fill(0);
  textSize(30);
  String shortName = filename.substring(53, filename.length());
